...
<body>
	...
	<form action="del_back1.php" method="POST">
		<i><h1 class="name" align="center" style="font-weight: bold;margin-left: 23%; font-size: 50px;width: 52%; color: white; top: 10px; background-color: grey">DELETE A STAFF DETAIL</h1></i>
...
<div class="container" align="center"><br>
	<div align="center">	
		<div class="box1" align="center">	
			<label style="font-size: 25px;"><b>Staff ID</b>&emsp;&emsp;&emsp;&emsp;&emsp;<input type="text" name="stfid" placeholder="Eg: 123456789" autofocus required title="Staff ID"></label><br><br><br>
