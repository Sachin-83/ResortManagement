...
<body>
	...
	<form action="upd_back1.php" method="POST">
		<i><h1 class="name" align="center" style="font-weight: bold;margin-left: 23%; font-size: 50px;width: 52%; color: white; top: 10px; background-color: grey">UPDATE STAFF DETAILS</h1></i>
