...
<body>
	...
	<form action="del_back.php" method="POST">
		<i><h1 class="name" align="center" style="font-weight: bold;margin-left: 23%; font-size: 50px;width: 52%; color: white; top: 10px; background-color: grey">DELETE A CUSTOMER DETAIL</h1></i>
...
<div class="container" align="center"><br>
	<div align="center">	
		<div class="box1" align="center">	
			<label style="font-size: 25px;"><b>MembershipID</b>&emsp;&emsp;<input type="text" name="MembershipID" placeholder="Eg: 123456789" autofocus required title="MembershipID"></label><br><br><br>
			...
			<button type="submit" style="color: white;font-size: 25px; " st class="book" name="reg_user">Delete</button>
		</div>
	</div>	
</div>
</div>
