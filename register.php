...
<fieldset style="border-color: darkgrey">
    <section class="div1">
    <i><h1 class="name" align="center" style="font-weight: bold; font-size: 70px; color: white; top: 10px;">Resort Management</h1></i>
        <a href="About.html#about"><input type="button" value="About" onclick="#" class="non1"></a>
        <a href="club.html#home"><input type="button" value="Home" onclick="#" class="non3"></a>
    </section>
